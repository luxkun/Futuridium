    ...
    public class GameBackground : Background
    {
        ...
        public override void Start()
        {
            ...
            if (SpawnSmallObj)
            {
                ...
                var maxStepX = (Room.Width - WallWidth * 2) / BlockW - 1;
                var maxStepY = (Room.Height - WallHeight * 2) / BlockH - 1;
                var spawnedCount = 0;
        ...
        public void InitDoors()
        {
            ...
            if (Room.Top != null)
            {
                ...
                topDoor.x = Room.Width / 2 - topDoorWidth / 2;
            ...
            if (Room.Left != null)
            {
                ...
                leftDoor.y = Room.Height / 2 - leftDoorHeight / 2;
            }
            if (Room.Bottom != null)
            {
                ...
                bottomDoor.x = Room.Width / 2 - bottomDoorWidth / 2;
                bottomDoor.y = Room.Height - bottomDoorHeight - PaddingFromEnd;
            }
            if (Room.Right != null)
            {
                ...
                rightDoor.x = Room.Width - rightDoorWidth - PaddingFromEnd;
                rightDoor.y = Room.Height / 2 - rightDoorHeight / 2;
            }
        }
